<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterMembership.aspx.cs" Inherits="ProjectCIS.RegisterMembership" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="text-left" style="font-size: xx-large; text-align: left">
        <span style="font-size: large"><strong>What is your surname?: </strong></span><strong>
    ...
    <p class="text-left" style="font-size: xx-large; text-align: left">
        <span style="font-size: large"><strong>What is your email?: </strong></span><strong>
    ...
    <p class="text-left" style="font-size: xx-large; text-align: left">
        <span style="font-size: large"><strong>What is your address?: </strong></span><strong>
    ...
    <p class="text-left" style="font-size: xx-large; text-align: left">
        <span style="font-size: large"><strong>What would you like your username to be? </strong></span><strong>
    ...
    <p class="text-left" style="font-size: xx-large; text-align: left">
        <span style="font-size: large"><strong>What would you like your password to be?</strong></span> <strong>
    ...
    <p class="text-left">
        <strong><span style="font-size: large">Name on card: </span>
        <asp:TextBox ID="NTxtbx" runat="server" style="font-size: large; " Height="26px"></asp:TextBox>
    ...
    <p class="text-left">
        <strong><span style="font-size: large">Expiry date:&nbsp;&nbsp;
        <asp:DropDownList ID="eMonthTbx" runat="server" Width="150px">
        ...
        &nbsp; 
        <asp:TextBox ID="eYearTbx" runat="server" Width="211px" style="font-size: large" TextMode="Number" Height="27px" required >Year e.g (18, 19)</asp:TextBox>
        &nbsp;&nbsp;
